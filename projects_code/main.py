...
def load_plays():
    ...
    """
    with open("C:/Users/Айгуль/PycharmProjects/test_sentiment/projects_data_in/3.txt", "r", encoding="utf-8") as f:
...
def prepare_lexicons():
    ...
    """
    path_to_lexicons = "C:/Users/Айгуль/PycharmProjects/test_sentiment/sentiment_datasets"
    lexicons = [lex[:-4] for lex in os.listdir(path_to_lexicons) if lex.endswith(".csv")]
    lexicons_dict = {}
    for lexicon in lexicons:
        lex_df = pd.read_csv("C:/Users/Айгуль/PycharmProjects/test_sentiment/sentiment_datasets/{}.csv".format(lexicon),
                             sep=";", encoding="utf-8")
...
def pipeline_analysis_by_line(lexicons_dict, play_list, mystem):
    ...
    for play_name in tqdm(play_list):
        with open("C:/Users/Айгуль/PycharmProjects/test_sentiment/projects_data_in/3.txt", "r", encoding="utf-8") as spoken_src:
...
def analyse_play(overall_dict, play_name, lexicon_name, lexicon, mystem):
    ...
    with open("C:/Users/Айгуль/PycharmProjects/test_sentiment/projects_data_in/3.txt", "r", encoding="utf-8") as stage_src:
...
def pipeline_analysis_by_play(lexicons_dict, play_list, mystem):
    ...
    print(df)
    df.to_csv("C:/Users/Айгуль/PycharmProjects/test_sentiment/"
              "projects_data_output/lexicons_by_line_data_for_3.csv", sep=";", encoding="utf-8", index=False)
